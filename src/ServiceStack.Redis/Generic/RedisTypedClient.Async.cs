...
namespace ServiceStack.Redis.Generic
{
        ...
        : IRedisTypedClientAsync<T>
    {
        ...
        IRedisClientAsync IRedisTypedClientAsync<T>.RedisClient => throw new NotImplementedException();
        ...
        async ValueTask<T> IRedisTypedClientAsync<T>.GetAndSetValueAsync(string key, T value, CancellationToken cancellationToken)
            => DeserializeValue(await AsyncNative.GetSetAsync(key, SerializeValue(value), cancellationToken).ConfigureAwait(false));
        ...
        ValueTask<bool> IRedisTypedClientAsync<T>.ExpireInAsync(object id, TimeSpan expiresAt, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        ValueTask<bool> IRedisTypedClientAsync<T>.ExpireAtAsync(object id, DateTime dateTime, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        ValueTask<bool> IRedisTypedClientAsync<T>.ExpireEntryInAsync(string key, TimeSpan expiresAt, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        ValueTask<bool> IRedisTypedClientAsync<T>.ExpireEntryAtAsync(string key, DateTime dateTime, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }

        ValueTask<TimeSpan> IRedisTypedClientAsync<T>.GetTimeToLiveAsync(string key, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        ValueTask<T[]> IRedisTypedClientAsync<T>.SearchKeysAsync(string pattern, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        ValueTask<HashSet<T>> IRedisTypedClientAsync<T>.GetAllItemsFromSetAsync(IRedisSet<T> fromSet, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        ValueTask<HashSet<T>> IRedisTypedClientAsync<T>.GetIntersectFromSetsAsync(IRedisSet<T>[] sets, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        ValueTask<HashSet<T>> IRedisTypedClientAsync<T>.GetUnionFromSetsAsync(IRedisSet<T>[] sets, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        ValueTask<HashSet<T>> IRedisTypedClientAsync<T>.GetDifferencesFromSetAsync(IRedisSet<T> fromSet, IRedisSet<T>[] withSets, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        ValueTask<T> IRedisTypedClientAsync<T>.BlockingRemoveStartFromListAsync(IRedisList<T> fromList, TimeSpan? timeOut, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
        ...
        T IRedisTypedClientAsync<T>.GetItemFromListAsync(IRedisList<T> fromList, int listIndex, CancellationToken cancellationToken)
        {
            throw new NotImplementedException();
        }
